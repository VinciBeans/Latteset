...
| ㉔ | 文档欠账：`cli-mcp-plan.md` 的路径引用迁到 `texpresso-infra` | 2026-09 | §1.3 的 `src-tauri/runner.rs` / `src-tauri/storage.rs` 已改为 `crates/texpresso-infra/src/{runner,storage}.rs` |
